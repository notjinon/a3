...
VALUES
-- Individual customers (starting from ID 5 to avoid conflicts with startup_data)
(5, 'Robert', 'Anderson', 'robert.anderson@email.com', '555-111-2222', '742 Evergreen Terrace', 'Springfield', 'IL', '62701'),
(6, 'Jennifer', 'Martinez', 'jennifer.m@email.com', '555-222-3333', '123 Maple Drive', 'Chicago', 'IL', '60601'),
(7, 'Thomas', 'Wilson', 'thomas.wilson@email.com', '555-333-4444', '456 Oak Street', 'Peoria', 'IL', '61602'),
(8, 'Jessica', 'Brown', 'jessica.brown@email.com', '555-444-5555', '789 Pine Avenue', 'Rockford', 'IL', '61101'),
(9, 'Christopher', 'Taylor', 'chris.taylor@email.com', '555-555-6666', '101 Cedar Lane', 'Aurora', 'IL', '60505'),
(10, 'Ashley', 'Davis', 'ashley.davis@email.com', '555-666-7777', '202 Birch Street', 'Naperville', 'IL', '60540'),
(11, 'Matthew', 'Garcia', 'matt.garcia@email.com', '555-777-8888', '303 Walnut Road', 'Joliet', 'IL', '60431'),
(12, 'Amanda', 'Lopez', 'amanda.lopez@email.com', '555-888-9999', '404 Spruce Court', 'Springfield', 'IL', '62704'),
(13, 'Daniel', 'Lee', 'daniel.lee@email.com', '555-999-0000', '505 Elm Boulevard', 'Champaign', 'IL', '61820'),
(14, 'Stephanie', 'Gonzalez', 'steph.g@email.com', '555-000-1111', '606 Pineapple Way', 'Bloomington', 'IL', '61701'),

-- Company representative contacts
(15, 'James', 'Carter', 'james.carter@techinnovate.com', '555-112-3344', '1000 Tech Park', 'Chicago', 'IL', '60607'),
(16, 'Linda', 'Thompson', 'linda.t@foodcorp.com', '555-223-4455', '2000 Food Avenue', 'Chicago', 'IL', '60608'),
(17, 'William', 'Harris', 'william.h@furniturefirst.com', '555-334-5566', '3000 Furniture Boulevard', 'Springfield', 'IL', '62711'),
(18, 'Patricia', 'Clark', 'patricia.c@fashionforward.com', '555-445-6677', '4000 Fashion Street', 'Chicago', 'IL', '60609'),
(19, 'Richard', 'Lewis', 'richard.l@officesuppliers.com', '555-556-7788', '5000 Office Road', 'Peoria', 'IL', '61604');
...
VALUES
(15, 'TechInnovate Solutions', '12-3456789'),
(16, 'FoodCorp Industries', '23-4567890'),
(17, 'Furniture First', '34-5678901'),
(18, 'Fashion Forward', '45-6789012'),
(19, 'Office Suppliers Inc.', '56-7890123');
...
(1, 5, '2024-01-05', '2024-01-05', 'Paid', 'PickedUp'),
...
(13, 15, '2024-01-10', '2024-01-10', 'Paid', 'PickedUp'),
(14, 16, '2024-01-25', '2024-01-25', 'Paid', 'PickedUp'),
(15, 17, '2024-02-08', '2024-02-08', 'Paid', 'PickedUp'),
(16, 18, '2024-02-20', '2024-02-20', 'Paid', 'PickedUp'),
(17, 19, '2024-03-05', '2024-03-05', 'Paid', 'PickedUp'),
(18, 15, '2024-03-15', '2024-03-15', 'Overdue', 'PickedUp'),
(19, 17, '2024-03-30', '2024-03-30', 'Paid', 'PickedUp'),
(20, 19, '2024-04-08', NULL, 'Pending', 'Pending'),
(21, 18, '2024-04-11', NULL, 'Pending', 'Pending');
...
(13, '2024-01-12', 1, 15, 'Completed'),
(14, '2024-01-27', 2, 16, 'Completed'),
(15, '2024-02-10', 1, 17, 'Completed'),
(16, '2024-02-22', 2, 18, 'Completed'),
(17, '2024-03-07', 1, 19, 'Completed'),
(18, '2024-03-17', 2, 15, 'Completed'),
(19, '2024-04-01', 1, 17, 'Completed'),

-- Scheduled pickups
(11, '2024-04-15', 3, 6, 'Scheduled'),
(12, '2024-04-16', 4, 5, 'Scheduled'),
(20, '2024-04-12', 1, 19, 'Scheduled'),
(21, '2024-04-14', 2, 18, 'Scheduled');
...
(3, 15, 1, 13, 'Two of the laptops we ordered are missing power adapters.', 'The missing power adapters have been delivered on March 20th.', 'Resolved', '2024-01-15 09:45:00'),
...
(5, 17, 2, 15, 'Three of the office chairs have different colors than what we ordered.', 'We are arranging for pickup and replacement of the incorrectly colored chairs.', 'In Progress', '2024-02-12 11:10:00'),

-- Open complaints
(6, 7, NULL, 3, 'The jeans I received are the wrong size.', NULL, 'Open', '2024-01-23 13:25:00'),
(7, 19, NULL, 17, 'We were charged twice for the same order.', NULL, 'Open', '2024-03-08 15:40:00'),
